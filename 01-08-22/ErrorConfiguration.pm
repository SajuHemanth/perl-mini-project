...
our %error_print=('1'=>"The New registeration is done successfully!!!",
                  '2'=>"Thanks for reserving your flight ticket with us",
                  '3'=>"We Wish you a pleasant flight with us:)",
                  '4'=>"\nplease select the reasons for cancellation(1/2/3/4):",
                  '5'=>"Your Request has been Accepted further details regarding cancellation will be updated shortly\n",
                  '6'=>"Please enter the valid reason\n",
                  '7'=>"Choose the valid reason for cancellation:\n",
                  '8'=>"Details are Registered...Thank you\n",
                  '9'=>"Choice Invalid\n");
